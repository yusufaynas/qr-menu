...
const menuData = [
    ...
    },
    {
        ...
        category: "simitler",
        price: "20 TL",
        description: " klasik taban simit",
    ...
    },
    {
        ...
        price: "50 TL",
        description: "salam,kaşar,domates ve marullu hamburger",
    ...
    },
    {
        ...
        category: "borek",
        price: "80 TL",
        description: "Otlu peynirli gül böreği",
    ...
    {id: 14, name: "Rulo Pasta", category: "pastalar", price: "500 TL", description: "Rulo şekilde sarılmış özel pasta", images: ["./pastalar/rulopasta.jpg"]},
    ...
    { id:81, name: "Malaga", category: "pastalar", price: "200 TL", description: "yumuşak kakaolu pandispanya tabanı üzerine yerleştirilen bütün muzlar, yoğun pastacı kreması (veya krema) ve tamamını kaplayan çikolata ganajından oluşur", images: ["./pastalar/malaga.jpg"]},
    ...
    // EKLER
    {id: 21, name: "Ekler - Klasik", category: "eklerler", price: "30 TL", description: "Siyah çikolatalı", images: [ 
        "./ekler/klasik.jpg"]},
    {id: 22, name: "Ekler - Lotuslu", category: "eklerler", price: "30 TL", description: "Lotus bisküvi kırıntılarıyla yapılan lezzetli ekler", images: [
    ...
    // BÖREKLER
    {id: 24, name: "Kıymalı Kol Böreği", category: "borek", price: "125 TL", description: "İnce yufka katları arasında özenle kavrulmuş kıyma, soğan ve baharatlarla hazırlanmış geleneksel lezzet.", images: ["./börekler/kıymalıkolböreği.jpg"]},
    {id: 23, name: "Tepsi Böreği", category: "borek", price: "125 TL", description: "özel el açmasıyla hazırlanmış otlu peynirli,patatesli,patlıcan kıymalı çeşitleriyle tepsi böreği", images: [
        "./börekler/tepsi.jpg"]},
    {id: 25, name: "peynirli kol böreği", category: "borek", price: "125 TL", description: "İnce açılmış yufkaların arasına bol beyaz peynir ve maydanoz konularak hazırlanır, çıtır çıtır pişirilir.", images: ["./börekler/peynirlikolböreği.jpg"]},

{ id: 75, name: "sigara böreği", category: "borek", price: "40 TL", description: "patatesli ve otlu peynirli çeşitleriyle sigara böreği", images: ["./börekler/sigara.jpg"]},
{id: 76, name: "Boyoz", category: "borek", price: "20 TL", description: "İzmir Boyozu", images: ["./börekler/boyoz.jpg"]},

    // PIZZALAR
    {id: 25, name: "Yuvarlak Pizza", category: "pizza", price: "60 TL", description: "Klasik yuvarlak şekilde karışık ve lezzetli pizza", images: ["./pizzalar/yuvarlak.jpg"]},
...
images: ["./pizzalar/karışık.jpg"]
    ...
    // POĞAÇALAR
    {id: 26, name: "kaşarlı Poğaça", category: "pogaca", price: "25 TL", description: "kaşarlı poğaça", images: ["./poğaçalar/kaşarlı.jpg"]},
    {id: 27, name: "patatesli Poğaça", category: "pogaca", price: "25 TL", description: "patatesli poğaça", images: ["./poğaçalar/patatesli.jpg"]},
{
    id: 43,
name: "peynirli Poğaça",
category: "pogaca",
price: "25 TL",description: "peynirli poğaça",
images: ["./poğaçalar/peynirli.jpg"]
},


    // KASE TATLILAR
    {id: 28, name: "Sütlaç", category: "kase_tatli", price: "150 TL", description: "Süt, pirinç ve şekerle hazırlanıp fırında üzeri hafif kızartılan geleneksel lezzet.", images: ["./kasetatlılar/sütlaç.jpg"]},
    {id: 29, name: "Kase Lotus", category: "kase_tatli", price: "180 TL", description: "Lotuslu muhallebi ve çikolatalı tatlı", images: ["./kasetatlılar/lotus.jpg"]},
{    id: 44,
name: "Supangle",
category: "kase_tatli",price: "150 TL",
...
category: "kase_tatli",
price: "150 TL",
description: "Alaçatı Muhallebisi; taze süt, vanilya ve hafif şekerle hazırlanmış, üzerine badem ve tarçın serpilerek sunulan yöresel bir tatlıdır.",
images: ["./kasetatlılar/alaçatı.jpg"]
},


    // TATLILAR - SÜTLÜ TATLILAR
    {id: 28, name: "Sütlaç", category: "sutlu_tatli", price: "150 TL", description: "Süt, pirinç ve şekerle hazırlanıp fırında üzeri hafif kızartılan geleneksel lezzet.", images: ["./kasetatlılar/sütlaç.jpg"]},
    {id: 31, name: "Karamelli Trileçe", category: "sutlu_tatli", price: "150TL", description: "Karamelli trileçe", images: ["./sütlütatlılar/karamellitrileçe.jpg"]},
    {id: 53, name: "Frambuazlı Trileçe", category: "sutlu_tatli", price: "150 TL", description: "Frambuazlı  lezzetli trileçe", images: ["./sütlütatlılar/frambuazlıtrileçe.jpg"]},
    {id: 55, name: "Soğuk Baklava", category: "sutlu_tatli", price: "150 TL", description: "Şerbetli, sütlü, cevbizli soğuk baklava tatlı", images: ["./sütlütatlılar/soğukbaklava.jpg"]},
    {id: 56, name: "Süt Dilimi", category: "sutlu_tatli", price: "150 TL", description: "Lezzetli süt dolgulu dilim tatlı", images: ["./sütlütatlılar/sütdilimi.jpg"]},    {id: 57, name: "Kazandibi", category: "sutlu_tatli", price: "150 TL", description: "Tat kakaolu kazandibi tatlı", images: ["./kasetatlılar/kazandibi.jpg"]},
    {id: 58, name: "Keşkül", category: "sutlu_tatli", price: "150 TL", description: "Süt, pirinç unu ve bademle hazırlanmış, hafif ve ferah bir sütlü tatlı. ", images: ["./kasetatlılar/Keşkül.jpg"]},
    {id: 59, name: "Magnolya", category: "sutlu_tatli", price: "150 TL", description: "Çilekli ve çikolatalı magnolya tatlı", images: ["./kasetatlılar/magnolya.jpg"]},
    {id: 60, name: "Kadayıflı Muhallebi", category: "sutlu_tatli", price: "150 TL", description: "Kadayıflı ve muhallebi kase tatlı", images: ["./kasetatlılar/kadayıflımuhallebi.jpg"]},
    {id: 61, name: "Alaçatı Muallabesi", category: "sutlu_tatli", price: "150 TL", description: "Alaçatı Muhallebisi; taze süt, vanilya ve hafif şekerle hazırlanmış, üzerine badem ve tarçın serpilerek sunulan yöresel bir tatlıdır. Hafif kıvamı ve ferah aromasıyla Ege’nin en sevilen sütlü tatlılarından biridir", images: ["./kasetatlılar/alaçatı.jpg"]},
    {id: 62, name: "Kırmızı Kadife", category: "sutlu_tatli", price: "150 TL", description: "Kırmızı kadife muhallebi ve çikolatalı sos ile hazırlanan kase tatlı", images: ["./kasetatlılar/kadife.jpg"]},
    {id: 63, name: "Senatör", category: "sutlu_tatli", price: "150 TL", description: "Antep fıstıklı muhallebi ve çikolatalı sos ile hazırlanan senatör tatlı", images: ["./kasetatlılar/senatör.jpg"]},
    {id: 64, name: "Kazandibi", category: "sutlu_tatli", price: "150 TL", description: "Kazandibi tatlı", images: ["./kasetatlılar/kazandibi.jpg"]},


    // ŞERBETLİ TATLILAR
    {id: 32, name: "Cevizli Baklava", category: "serbetli_tatli", price: "120 TL", description: "Cevizli, şerbetli baklavalar", images: ["./serbetli_tatlilar/cevizli.jpg"]},
{id: 33, name: "Soğuk Baklava", category: "serbetli_tatli", price: "150 TL", description: "cevizli soğuk baklava", images: ["./serbetli_tatlilar/sogukbaklava.jpg"]},
{id: 49, name: "Şekerpare", category: "serbetli_tatli", price: "120 TL", description: "Şekerpare", images: ["./serbetli_tatlilar/sekerpare.jpg"]},
{id: 50, name: "Kalburabastı", category: "serbetli_tatli", price: "120 TL", description: "Kalburabastı", images: ["./serbetli_tatlilar/kalburabasti.jpg"]},

    // KURU PASTALAR
    {id: 51, name: "Un Kurabiyesi", category: "kuru_pastalar", price: "500 TL", description: "Ağızda dağılan klasik un kurabiyesi", images: ["data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 300 200'%3E%3Crect fill='%23F5DEB3' width='300' height='200'/%3E%3Ccircle cx='120' cy='100' r='42' fill='%23D2B48C'/%3E%3Ccircle cx='180' cy='100' r='42' fill='%23C8A97E'/%3E%3Ctext x='150' y='110' font-size='30' fill='white' text-anchor='middle'%3E🍪%3C/text%3E%3C/svg%3E"]},
    {id: 52, name: "Tuzlu Kurabiye", category: "kuru_pastalar", price: "500 TL", description: "Çay saatine uygun susamlı tuzlu kurabiye", images: ["data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 300 200'%3E%3Crect fill='%23EED7B0' width='300' height='200'/%3E%3Cellipse cx='150' cy='100' rx='80' ry='48' fill='%23B08968'/%3E%3Ctext x='150' y='112' font-size='30' fill='white' text-anchor='middle'%3E🥨%3C/text%3E%3C/svg%3E"]},


    // İÇECEKLER
    {id: 34, name: "Fanta", category: "sogukicecekler", price: "80 TL", description: "soğuk fanta", images: ["./sogukicecekler/fanta.jpg"]},
    {id: 35, name: "Fuse tea", category: "sogukicecekler", price: "80 TL", description: "çilek karpuzlu,mango ananaslı,şeftalili fuse tea", images: ["./sogukicecekler/fusetea.jpg"]},
    {id: 36, name: "kola", category: "sogukicecekler", price: "80 TL", description: "soğuk kola", images: ["./sogukicecekler/kola.jpg"]},
    {id: 37, name: "Ayran", category: "sogukicecekler", price: "  30 TL", description: "Taze, soğuk ayran", images: ["./sogukicecekler/ayran.jpg"]},
    {id: 38, name: "Sade Soda", category: "sogukicecekler", price: "25 TL", description: "Serinletici soda", images: ["./sogukicecekler/sadesoda.jpg"]},
    {id: 39, name: "Limonata", category: "sogukicecekler", price: "100 TL", description: "Ev yapımı taze limonata", images: ["./sogukicecekler/limonata.jpg"]},
    {id: 40, name: "Meyve Suyu", category: "sogukicecekler", price: "30TL", description: "Çeşitli meyve aromalı meyve suyu", images: ["./sogukicecekler/meyvasuyu.jpg"]},
    ...
    // Sıcak İçecekler
    {id: 45, name: "Türk Kahvesi", category: "sıcakicecekler", price: "80 TL", description: "Geleneksel Türk kahvesi", images: ["./sıcakicecekler/turkkahvesi.jpg"]},
    {id: 46, name: "Çay", category: "sıcakicecekler", price: "30 TL", description: "Taze kaynatılmış çay", images: ["./sıcakicecekler/cay.jpg"]},
    {id: 47, name: "adacayı", category: "sıcakicecekler", price: "100 TL", description: "Kurutulmuş ada yapraklarından demlenerek hazırlanan, ferah aromalı geleneksel içecek.", images: ["./sıcakicecekler/adacayı.jpg"]},
    {id: 48, name: "filtre kahve", category: "sıcakicecekler", price: "100 TL", description: "Filtre kahve", images: ["./sıcakicecekler/filtrekahve.jpg"]},
    {id: 49, name: "ıhlamur", category: "sıcakicecekler", price: "100 TL", description: "Ihlamur çayı", images: ["./sıcakicecekler/ıhlamur.jpg"]},
    {id: 50, name: "nane limon", category: "sıcakicecekler", price: "100 TL", description: "Nane limon çayı", images: ["./sıcakicecekler/nanelimon.jpg"]},
    {id: 51, name: "papatya çayı", category: "sıcakicecekler", price: "100 TL", description: "Papatya çayı", images: ["./sıcakicecekler/papatya.jpg"]},
    {id: 52, name: "salep", category: "sıcakicecekler", price: "100 TL", description: " klasik Salep ", images: ["./sıcakicecekler/salep.jpg"]},
    {id: 53, name: "sıcak çikolata", category: "sıcakicecekler", price: "100 TL", description: "Sıcak çikolata", images: ["./sıcakicecekler/sicakcikolata.jpg"]},

    // kurapasta 
    {id: 54, name: "Un Kurabiyesi", category: "kurupastalar", price: "125 TL", description: "Ağızda dağılan klasik un kurabiyesi", images: ["./kurupastalar/unlu.jpg"]},
    {id: 55, name: "Tuzlu Kurabiye", category: "kurupastalar", price: "125 TL", description: "Çay saatine uygun susamlı tuzlu kurabiye", images: ["./kurupastalar/tuzlu.jpg"]},
    {   id: 56, name: "leblebili Kurabiyesi", category: "kurupastalar", price: "125 TL", description: "Fındık aromalı çıtır kurabiye", images: ["./kurupastalar/leblebili.jpg"]},
    {   id: 57, name: "dereotlu kurabiye", category: "kurupastalar", price: "125 TL", description: "Dereotlu kurabiye", images: ["./kurupastalar/dereotlu.jpg"]},
    {   id: 58, name: "elmalı Kurabiye", category: "kurupastalar", price: "125 TL", description: "Elmalı kurabiye", images: ["./kurupastalar/elmalı.jpg"]},
    {   id: 59, name: "leblebili kurabiye", category: "kurupastalar", price: "125 TL", description: "Leblebili kurabiye", images: ["./kurupastalar/leblebili.jpg"]},
    {   id: 60, name: "damla çikolatalı kurabiye", category: "kurupastalar", price: "125 TL", description: "Damla çikolatalı kurabiye", images: ["./kurupastalar/damla.jpg"]},
    {   id: 61, name: "kakaolu kurabiye", category: "kurupastalar", price: "125 TL", description: "Kakaolu kurabiye", images: ["./kurupastalar/kakaolu.jpg"]},
    {   id: 62, name: "tahinli kurabiye", category: "kurupastalar", price: "125 TL", description: "Tahinli kurabiye", images: ["./kurupastalar/tahinli.jpg"]},
    {   id: 63, name: "çubuklu kurabiye", category: "kurupastalar", price: "125 TL", description: "Çubuklu kurabiye", images: ["./kurupastalar/çubuklu.jpg"]},
    {   id: 64, name: "Simit kurabiye", category: "kurupastalar", price: "125 TL", description: "Simit kurabiye", images: ["./kurupastalar/simitkuru.jpg"]},
    ...
    {   id: 68, name: "zeytin tabağı", category: "kahvalti", price: "80 TL", description: "çeşitli zeytinler ve taze ekmeklerle dolu zeytin tabağı", images: ["./kahvalti/zeytin.jpg"]},
    {   id: 69, name:"tulum peyniri", category: "kahvalti", price: "20 TL", description: "taze tulum peyniri ve taze ekmeklerle dolu tulum peyniri tabağı", images: ["./kahvalti/tulum.jpg"]},
    ...
    {   id: 71, name:"bal", category: "kahvalti", price: "80 TL", description: "taze bal ve taze ekmeklerle dolu bal tabağı", images: ["./kahvalti/bal.jpg"]},
    {   id: 72, name:"tereyağı", category: "kahvalti", price: "80 TL", description: "taze tereyağı ve taze ekmeklerle dolu tereyağı tabağı", images: ["./kahvalti/tereyağ.jpg"]},
    {   id:73, name:"haşlanmış yumurta", category: "kahvalti", price: "20 TL", description: "taze haşlanmış yumurta ve taze ekmeklerle dolu haşlanmış yumurta tabağı", images: ["./kahvalti/yumurta.jpg"]},
